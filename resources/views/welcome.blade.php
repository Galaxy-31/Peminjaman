...
<body class="">
    ...
    <main class="main-content  mt-0 ">
        <div class="page-header align-items-start min-vh-70 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSU1Ce26p-qfsX1o_JNFVr1jsLvPXBWVTdc2NEh9ML8Jg&s'); background-position: top;">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Halo Pengguna!</h1>
                        <p class="text-lead text-white"> Aplikasi Peminjaman Gawai</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-8 mx-auto text-center mt-1">
                    <p class="mb-0 text-secondary mt-3">
                        ...
                        </script>. Created Kelompok Peminjaman Gawai
                    </p>
                </div>
            </div>
        </div>
